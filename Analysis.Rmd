...
ggplot(age.filtered, aes(x = AgeYear, fill = AnimalType)) +
...
cat("Probability Distribution of 1 year old animals or older: ", age.filtered$Frequency / sum(age.filtered$Frequency))
cat("Poisson Distribution: ", dpois(1:18, lambda = 1.6))
```
...
outcomes <- unique(train.copy$OutcomeType)
